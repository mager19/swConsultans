...
<div class="container mx-auto">
        ...
        <div class="container mx-auto">
          <div class="flex flex-wrap px-4">
            <div class="email w-8/12 md:w-1/2">
              <a href="#" class="text-white flex items-center gap-2 text-overline py-3 visited:text-white">
                <figure>
            ...
            <ul class="icons-link w-4/12 md:w-1/2 flex gap-2 justify-end items-center">
              <li class="item1">
                <a href="#">
              ...
              <li class="item2">
                <a href="#">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.25 0.25C12.6478 0.25 13.0294 0.408035 13.3107 0.68934C13.592 0.970644 13.75 1.35218 13.75 1.75V12.25C13.75 12.6478 13.592 13.0294 13.3107 13.3107C13.0294 13.592 12.6478 13.75 12.25 13.75H1.75C1.35218 13.75 0.970644 13.592 0.68934 13.3107C0.408035 13.0294 0.25 12.6478 0.25 12.25V1.75C0.25 1.35218 0.408035 0.970644 0.68934 0.68934C0.970644 0.408035 1.35218 0.25 1.75 0.25H12.25ZM11.875 11.875V7.9C11.875 7.25155 11.6174 6.62965 11.1589 6.17112C10.7003 5.7126 10.0785 5.455 9.43 5.455C8.7925 5.455 8.05 5.845 7.69 6.43V5.5975H5.5975V11.875H7.69V8.1775C7.69 7.6 8.155 7.1275 8.7325 7.1275C9.01098 7.1275 9.27805 7.23812 9.47496 7.43504C9.67188 7.63195 9.7825 7.89902 9.7825 8.1775V11.875H11.875ZM3.16 4.42C3.49417 4.42 3.81466 4.28725 4.05095 4.05095C4.28725 3.81466 4.42 3.49417 4.42 3.16C4.42 2.4625 3.8575 1.8925 3.16 1.8925C2.82384 1.8925 2.50144 2.02604 2.26374 2.26374C2.02604 2.50144 1.8925 2.82384 1.8925 3.16C1.8925 3.8575 2.4625 4.42 3.16 4.42ZM4.2025 11.875V5.5975H2.125V11.875H4.2025Z" fill="white"/>
                  </svg>
                </a>
              </li>
              <li class="item3">
        ...
        <div class="container mx-auto">
          <div class="flex flex-wrap px-4">
            ...
            <div class="icons-link w-4/12 md:w-1/2 flex gap-2 justify-end items-center">
              <div class="item1">
                <a href="#">
                  <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.845 1.5C15.2675 1.7625 14.645 1.935 14 2.0175C14.66 1.62 15.17 0.99 15.41 0.2325C14.7875 0.6075 14.0975 0.87 13.37 1.02C12.7775 0.375 11.945 0 11 0C9.23753 0 7.79753 1.44 7.79753 3.2175C7.79753 3.4725 7.82753 3.72 7.88003 3.9525C5.21003 3.8175 2.83253 2.535 1.25003 0.5925C0.972529 1.065 0.815029 1.62 0.815029 2.205C0.815029 3.3225 1.37753 4.3125 2.24753 4.875C1.71503 4.875 1.22003 4.725 0.785029 4.5V4.5225C0.785029 6.0825 1.89503 7.3875 3.36503 7.68C2.89307 7.80916 2.3976 7.82713 1.91753 7.7325C2.12123 8.37186 2.52018 8.93131 3.05829 9.3322C3.5964 9.73309 4.24661 9.95527 4.91753 9.9675C3.78025 10.8678 2.37053 11.3545 0.920029 11.3475C0.665029 11.3475 0.410029 11.3325 0.155029 11.3025C1.58003 12.2175 3.27503 12.75 5.09003 12.75C11 12.75 14.2475 7.845 14.2475 3.5925C14.2475 3.45 14.2475 3.315 14.24 3.1725C14.87 2.7225 15.41 2.1525 15.845 1.5Z" fill="white"/>
