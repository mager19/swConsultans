    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap px-4">
            <div class="email w-8/12 md:w-1/2">
                <a href="#" class="text-white flex items-center gap-2 text-overline hover:text-white hover:opacity-80 visited:text-white">
                    <figure>
            ...
            <div class="social__icons w-4/12 md:w-1/2 flex items-center justify-end">
                <ul class="flex gap-3 justify-end items-center m-0">
                    <li class="social__icons__item list-none mb-0">
                        <a href="#" class="hover:text-white hover:opacity-80 visited:text-white">
